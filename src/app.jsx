...
const projectData = [
  ...
  {
    title: "Money Laundry",
    link: "https://github.com/YehyunLee/big-data-ai-2026", // Update this link later!
...
function App() {
  return (
    <div className="grid grid-cols-2 grid-rows-2 gap-20 p-20 items-center justify-center h-screen scroll-mt-16">
